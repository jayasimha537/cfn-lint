...
class TestListDuplicates(BaseRuleTestCase):
    ...
    def test_duplicate(self):
        ...
        self.assertEqual(len(list(rule.uniqueItems(validator, True, ["a", "b"], {}))), 0)
        self.assertEqual(len(list(rule.uniqueItems(validator, True, ["a", "a"], {}))), 1)
        ...
        self.assertEqual(len(
            list(rule.uniqueItems(validator, True, [{"Key": "key", "Value": "value"}, {"Key": "key", "Value": "value"}], {})
        )), 1)
        self.assertEqual(len(
            list(rule.uniqueItems(validator, True, [{"Key": "key", "Value": "value"}, {"Key": "key", "Value": "another"}], {})
        )), 0)
        self.assertEqual(len(
            list(rule.uniqueItems(validator, True, [["a"], ["a"]], {})
        )), 1)
        self.assertEqual(len(
            list(rule.uniqueItems(validator, True, [["a"], ["b"]], {})
        )), 0)
